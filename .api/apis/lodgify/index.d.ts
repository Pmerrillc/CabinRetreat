...
declare class SDK {
     ...
     */
    getAllPropertiesAsync(metadata?: types.GetAllPropertiesAsyncMetadataParam): Promise<FetchResponse<200, types.GetAllPropertiesAsyncResponse200>>;
    /**
     ...
     */
    getPropertyByIdV2(metadata: types.GetPropertyByIdV2MetadataParam): Promise<FetchResponse<200, types.GetPropertyByIdV2Response200>>;
    /**
     ...
     */
    getV2PropertiesIdRooms(metadata: types.GetV2PropertiesIdRoomsMetadataParam): Promise<FetchResponse<200, types.GetV2PropertiesIdRoomsResponse200>>;
    /**
     ...
     */
    getAllDeletedAsync(metadata?: types.GetAllDeletedAsyncMetadataParam): Promise<FetchResponse<200, types.GetAllDeletedAsyncResponse200>>;
    /**
     ...
     */
    ratesCalendarV2(metadata: types.RatesCalendarV2MetadataParam): Promise<FetchResponse<200, types.RatesCalendarV2Response200>>;
    /**
     ...
     */
    rateSettingsV2(metadata?: types.RateSettingsV2MetadataParam): Promise<FetchResponse<200, types.RateSettingsV2Response200>>;
    /**
     ...
     */
    getCalendarByUser(metadata?: types.GetCalendarByUserMetadataParam): Promise<FetchResponse<200, types.GetCalendarByUserResponse200>>;
    /**
     ...
     */
    getCalendarByProperty(metadata: types.GetCalendarByPropertyMetadataParam): Promise<FetchResponse<200, types.GetCalendarByPropertyResponse200>>;
    /**
     ...
     */
    getCalendarByRoomType(metadata: types.GetCalendarByRoomTypeMetadataParam): Promise<FetchResponse<200, types.GetCalendarByRoomTypeResponse200>>;
    /**
     ...
     */
    getAllAsync(metadata?: types.GetAllAsyncMetadataParam): Promise<FetchResponse<200, types.GetAllAsyncResponse200>>;
    /**
     * Updates the access key codes of rooms belonging to a given booking.
     *
     * @summary Update rooms' access key codes
     * @throws FetchError<400, types.UpdateKeyCodesResponse400> Bad Request
     * @throws FetchError<401, types.UpdateKeyCodesResponse401> Unauthorized
     * @throws FetchError<404, types.UpdateKeyCodesResponse404> Booking or Room not found
     */
    updateKeyCodes(body: types.UpdateKeyCodesBodyParam, metadata: types.UpdateKeyCodesMetadataParam): Promise<FetchResponse<200, types.UpdateKeyCodesResponse200>>;
    updateKeyCodes(metadata: types.UpdateKeyCodesMetadataParam): Promise<FetchResponse<200, types.UpdateKeyCodesResponse200>>;
    /**
     ...
     */
    getExternalBookingsAsync(metadata: types.GetExternalBookingsAsyncMetadataParam): Promise<FetchResponse<200, types.GetExternalBookingsAsyncResponse200>>;
    /**
     * Booking by id
     *
     ...
     */
    getAsync(metadata: types.GetAsyncMetadataParam): Promise<FetchResponse<200, types.GetAsyncResponse200>>;
    /**
     ...
     */
    getPaymentLinkAsync(metadata: types.GetPaymentLinkAsyncMetadataParam): Promise<FetchResponse<200, types.GetPaymentLinkAsyncResponse200>>;
    /**
     * Create a payment link for a booking
     *
     * @throws FetchError<400, types.CreatePaymentLinkAsyncResponse400> Bad Request
     * @throws FetchError<401, types.CreatePaymentLinkAsyncResponse401> Unauthorized
     * @throws FetchError<404, types.CreatePaymentLinkAsyncResponse404> Not Found
     * @throws FetchError<500, types.CreatePaymentLinkAsyncResponse500> Server Error
     */
    createPaymentLinkAsync(body: types.CreatePaymentLinkAsyncBodyParam, metadata: types.CreatePaymentLinkAsyncMetadataParam): Promise<FetchResponse<200, types.CreatePaymentLinkAsyncResponse200>>;
    createPaymentLinkAsync(metadata: types.CreatePaymentLinkAsyncMetadataParam): Promise<FetchResponse<200, types.CreatePaymentLinkAsyncResponse200>>;
    /**
     ...
     */
    putV2ReservationsBookingsIdCheckin(body: types.PutV2ReservationsBookingsIdCheckinBodyParam, metadata: types.PutV2ReservationsBookingsIdCheckinMetadataParam): Promise<FetchResponse<number, unknown>>;
    /**
     ...
     */
    putV2ReservationsBookingsIdCheckout(body: types.PutV2ReservationsBookingsIdCheckoutBodyParam, metadata: types.PutV2ReservationsBookingsIdCheckoutMetadataParam): Promise<FetchResponse<number, unknown>>;
    /**
     * Gets a quote
     *
     ...
     */
    getV2QuotePropertyid(metadata: types.GetV2QuotePropertyidMetadataParam): Promise<FetchResponse<200, types.GetV2QuotePropertyidResponse200>>;
    /**
     ...
     */
    getV2MessagingThreadguid(metadata: types.GetV2MessagingThreadguidMetadataParam): Promise<FetchResponse<200, types.GetV2MessagingThreadguidResponse200>>;
}
