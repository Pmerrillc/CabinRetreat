...
const BookNowText = () => {
  ...
  return (
    <div className="lg:w-1/2 mb-8 lg:mb-0">
        ...
        <h1 className="text-[30px] font-bold mb-8 text-center">Discover your perfect <br />
         family-friendly cabin retreat</h1>
        <p className="text-md w-3/4 mb-8 text-center">
        Book today and enjoy vintage charm with modern comfort tomorrow
        </p>
        <p className='w-3/4 mb-2'> <span className="font-bold">Family Fun:</span> Swing set, fire pit, and nearby Pinecrest Lake offer endless entertainment.</p>
        <p className='w-3/4 mb-2'> <span className="font-bold">Vintage Charm:</span> Cozy up in the cabin's unique knotty pine interior and wood burning stove .</p>
        <p className='w-3/4 mb-10'> <span className="font-bold">Riverfront Escape:</span> Enjoy the sounds of the Stanislaus River and go fishing from the property.</p>
