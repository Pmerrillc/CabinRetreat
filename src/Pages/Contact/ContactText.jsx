    ...
    <div className='w-full flex flex-col items-center justify-center'>
      <div className='flex flex-col items-center'>
        <div className='flex flex-col h-[70vh] justify-between items-center'>
          <div className='flex flex-col md:flex-row w-full items-start  justify-between md:items-center'>
            <div>
          ...
          <div className='flex w-full justify-center mt-10 md:mt-0 mb-10'>
            <img 
